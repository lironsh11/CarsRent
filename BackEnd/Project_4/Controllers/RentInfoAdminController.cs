...
namespace Project_4.Controllers
{
    ...
    [ApiController]
    [EnableCors("Policy1")]
    public class RentInfoAdminController : ControllerBase
    {
        ...
        // GET: api/RentInfo/5
        [HttpGet("{id}", Name = "GetRentInfoAdmin")]
        ...
        // PUT: api/RentInfo/5
        [HttpPut]
        [Route("{id}/{carid}/{userid}/{rentdate}/{returndate}/{realreturndate}")]
        public ActionResult<RentInfo> UpdateRentInfo(int id, int carid, string userid, string rentdate, string returndate, string realreturndate)
        {
            ...
            try
            {
                ...
                if (CurrentRent != null)
                {
                    CurrentRent.CarId = carid;
                    CurrentRent.UserId = userid;
                    CurrentRent.RentDate = rentdate;
                    CurrentRent.ReturnDate = returndate;
                    CurrentRent.RealReturnDate = realreturndate;
