...
namespace Project_4.Controllers
{
    ...
    [ApiController]
    [EnableCors("Policy1")]
    public class CarsInfoAdminController : ControllerBase
    {
        ...
        // GET: api/CarsInfo/5
        [HttpGet("{id}", Name = "GetCarsInfoAdmin")]
        public ActionResult<CarsInfo> GetCarsById(int id)
        {
            CarsInfo result;
            try
            {
        ...
        // PUT: api/CarsInfo/5
        [HttpPut]
        [Route("{id}/{carid}/{carType}/{AvailableForRent}/{ProperForRent}/{CurrectMileage}/{pic}")]
        public ActionResult<RentInfo> UpdateCarInfo(int id, int carid, string carType, string AvailableForRent, string ProperForRent, int CurrectMileage , string pic)
        {
            CarsInfo CurrentCar;
            try
            {
                ...
                if (CurrentCar != null)
                {
                    ...
                    CurrentCar.CarType = carType;
                    CurrentCar.AvailableForRent = AvailableForRent;
                    CurrentCar.CurrectMileage = CurrectMileage;
                    CurrentCar.ProperForRent = ProperForRent;
                    CurrentCar.Picture = pic;
